...
namespace SchoolPortalApp.Controllers
{
    ...
    public class TeacherClassDetailsController : Controller
    {
        ...
        private void PopulateDropdowns(TeacherClassDetailsViewModel vm)
        {
            ...
            vm.Teachers = teachers.Select(t => new Microsoft.AspNetCore.Mvc.Rendering.SelectListItem { Value = t.Id.ToString(), Text = string.Join(" ", new[] { t.FirstName, t.LastName }.Where(x => !string.IsNullOrWhiteSpace(x))), Selected = t.Id == vm.TeacherId }).ToList();
            ...
            vm.Subjects = subjects.Select(su => new Microsoft.AspNetCore.Mvc.Rendering.SelectListItem { Value = su.Id.ToString(), Text = su.SubjectName, Selected = su.Id == vm.SubjectId }).ToList();
        }
