...
{
    public class TeacherSectionDetailsService : ITeacherSectionDetailsService
    {
        private static TeacherSectionDetails Map(DataRow r)
        {
            var e = new TeacherSectionDetails();
            ...
            if (r.Table.Columns.Contains("IsClassTeacher") && bool.TryParse(r["IsClassTeacher"]?.ToString(), out var isClassTeacher)) e.IsClassTeacher = isClassTeacher;
            ...
            if (r.Table.Columns.Contains("IsActive") && bool.TryParse(r["IsActive"]?.ToString(), out var isActive)) e.IsActive = isActive;
            if (r.Table.Columns.Contains("IsDeleted") && bool.TryParse(r["IsDeleted"]?.ToString(), out var isDeleted)) e.IsDeleted = isDeleted;
        ...
        public List<TeacherSectionDetails> GetAll()
        {
            var list = new List<TeacherSectionDetails>();
            Proc p = new Proc("TeacherSectionDetails_GetAll");
        ...
        public TeacherSectionDetails? GetById(Guid id)
        {
            Proc p = new Proc("TeacherSectionDetails_GetById");
            p["@Id"] = id;
            var dt = new DataTable();
            p.Exec(dt);
        ...
        public Guid Create(TeacherSectionDetails e)
        {
            Proc p = new Proc("TeacherSectionDetails_Create");
            p["@TeacherId"] = e.TeacherId;
            p["@ClassId"] = e.ClassId;
            p["@SectionId"] = e.SectionId;
            p["@SubjectId"] = e.SubjectId;
            p["@IsClassTeacher"] = e.IsClassTeacher;
        ...
        public bool Update(TeacherSectionDetails e)
        {
            Proc p = new Proc("TeacherSectionDetails_Update");
            p["@Id"] = e.Id;
            p["@TeacherId"] = e.TeacherId;
            p["@ClassId"] = e.ClassId;
            p["@SectionId"] = e.SectionId;
        ...
        {
            Proc p = new Proc("TeacherSectionDetails_Delete");
            p["@Id"] = id;
            p.Exec();
            var ret = p.Parameters["@RETURN_VALUE"].Value;
            int code = ret == null || ret == DBNull.Value ? 0 : Convert.ToInt32(ret);
