    ...
    public class NonTeachingQualificationDetailsService : INonTeachingQualificationDetailsService
    {
        ...
        private NonTeachingQualificationDetails Map(IDataReader reader)
        {
            return new NonTeachingQualificationDetails
            {
                ...
                QualificationType = GetColumnValue<string>(reader, "QualificationType"),
                Institution = reader["Institution"] != DBNull.Value ? reader["Institution"].ToString() : null,
                BoardUniversity = reader["BoardUniversity"] != DBNull.Value ? reader["BoardUniversity"].ToString() : null,
                YearOfPassing = reader["YearOfPassing"] != DBNull.Value ? reader["YearOfPassing"].ToString() : null,
                Percentage = (decimal)(reader["Percentage"] != DBNull.Value ? Convert.ToDecimal(reader["Percentage"]) : (decimal?)null),
                Division = reader["Division"] != DBNull.Value ? reader["Division"].ToString() : null,
                DocumentPath = reader["DocumentPath"] != DBNull.Value ? reader["DocumentPath"].ToString() : null,
                IsActive = GetColumnValue<bool>(reader, "IsActive", true),
                ...
                VerifiedOn = reader["VerifiedOn"] != DBNull.Value ? (DateTime)reader["VerifiedOn"] : DateTime.Today,
