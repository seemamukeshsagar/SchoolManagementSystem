...
{
    public class TeacherSubjectDetailsService : ITeacherSubjectDetailsService
    {
        private static TeacherSubjectDetails Map(DataRow r)
        {
            var e = new TeacherSubjectDetails();
        ...
        public List<TeacherSubjectDetails> GetAll()
        {
            var list = new List<TeacherSubjectDetails>();
            Proc p = new Proc("TeacherSubjectDetails_GetAll");
        ...
        public TeacherSubjectDetails? GetById(Guid id)
        {
            Proc p = new Proc("TeacherSubjectDetails_GetById");
            p["@Id"] = id;
            var dt = new DataTable();
            p.Exec(dt);
        ...
        public Guid Create(TeacherSubjectDetails e)
        {
            Proc p = new Proc("TeacherSubjectDetails_Create");
        ...
        public bool Update(TeacherSubjectDetails e)
        {
            Proc p = new Proc("TeacherSubjectDetails_Update");
            p["@Id"] = e.Id;
            p["@TeacherId"] = e.TeacherId;
            p["@SubjectId"] = e.SubjectId;
            p["@ClassId"] = e.ClassId;
        ...
        {
            Proc p = new Proc("TeacherSubjectDetails_Delete");
            p["@Id"] = id;
            p.Exec();
            var ret = p.Parameters["@RETURN_VALUE"].Value;
            int code = ret == null || ret == DBNull.Value ? 0 : Convert.ToInt32(ret);
