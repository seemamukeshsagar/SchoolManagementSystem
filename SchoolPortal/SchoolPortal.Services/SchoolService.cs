...
namespace SchoolPortal.Services
{
    public class SchoolService : ISchoolService
    {
        ...
        public Guid Create(SchoolMaster school)
        {
            ...
            p["@CityId"] = school.CityId ?? (object)DBNull.Value;
            p["@StateId"] = school.StateId ?? (object)DBNull.Value;
            p["@CountryId"] = school.CountryId ?? (object)DBNull.Value;
            p["@ZipCode"] = school.ZipCode ?? string.Empty;
            p["@EstablishmentYear"] = school.EstablishmentYear ?? string.Empty;
            p["@JudistrictionCityId"] = school.JudistrictionCityId ?? (object)DBNull.Value;
        ...
        public bool Update(SchoolMaster school)
        {
            ...
            p["@JudistrictionCityId"] = school.JudistrictionCityId ?? (object)DBNull.Value;
            p["@IsActive"] = school.IsActive;
            p["@ModifiedBy"] = school.ModifiedBy ?? (object)DBNull.Value;
            p.Exec();
        ...
        public string SchoolNameById(Guid id)
        {
            Proc p = new Proc("School_GetById");
            p["@Id"] = id;
            var dt = new DataTable();
